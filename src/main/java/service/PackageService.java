...
public class PackageService {
    ...
    public boolean addPackage(String name, String description, double priceMini, double priceSedan,
        ...
        Package pkg = new Package(0, name, description, priceMini, priceSedan, priceCuv, priceSuv, priceMpv, pricePickup, savings, status);
    ...
    public boolean updatePackage(int id, String name, String description, double priceMini, double priceSedan,
        ...
        Package pkg = new Package(id, name, description, priceMini, priceSedan, priceCuv, priceSuv, priceMpv, pricePickup, savings, status);
    ...
    public boolean addPackage(String name, String description, double price, double savings, String status) {
        return addPackage(name, description, price * 0.8, price, price * 1.5, price * 2, price * 2.1, price * 2.2, savings, status);
    }
    
    @Deprecated
    public boolean updatePackage(int id, String name, String description, double price, double savings, String status) {
        return updatePackage(id, name, description, price * 0.8, price, price * 1.5, price * 2, price * 2.1, price * 2.2, savings, status);
    }
